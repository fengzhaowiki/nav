...
const c: IConfig = {
  ...
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/fengzhaowiki/nav',
  ...
  // 您的网站地址，有利于SEO
  homeUrl: 'https://nav.fengzhao.wiki',
  ...
  // Site keywords
  // 网站关键字
  keywords: '导航,Linux,社区站点,设计师,实用工具,学习资源,运营,网络安全,数据库,node.js',
  ...
  footerContent: `
    ...
    <div>Copyright © 2018-2021 nav.fengzhao.wiki, All Rights Reserved</div>
  `,
